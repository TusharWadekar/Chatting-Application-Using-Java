...
public class Server implements ActionListener {
    ...
    Server(){
        ...
        Image i14=i13.getImage().getScaledInstance(8,26,Image.SCALE_DEFAULT);
        ImageIcon i15 = new ImageIcon(i14);
        JLabel morevert= new JLabel(i15);
        morevert.setBounds(380,20,5,25);
        p1.add(morevert);
        ...
        JLabel status=new JLabel("action now");
        ...
        sent.setBounds(320,650,75,40);
        sent.setBackground(new Color(7,94,84));
        sent.addActionListener(this);
        sent.setFont(new Font("SAN SERIF",Font.BOLD,14));
